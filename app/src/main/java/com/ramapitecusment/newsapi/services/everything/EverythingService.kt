...
class EverythingService(
    ...
    fun getFromRemote(searchTag: String): Maybe<retrofit2.Response<Response>> = api.getEverythingRemote(searchTag, API_KEY_VALUE)

    fun insertAll(articles: List<ArticleEntity>): Maybe<List<Long>> = dao.insertAllArticles(articles)
}